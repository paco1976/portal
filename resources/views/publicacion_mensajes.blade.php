				...
				<section  class="parallax" data-stellar-background-ratio="0.5" style="background-image: url( {{ asset('parallax-transparent.jpg') }} );">
					<div class="container">
                        ...
                        @endforeach
                            ...
                            <form action="{{ route('publicacion_mensaje_respuesta', ['id'=> $interactionhead->id]) }}" method="POST" enctype="multipart/form-data" >
							{{ method_field('PUT') }}
                            @csrf
                                ...
                                <div class="input-group mb-md">
                                    ...
                                    <a href="{{ route('publicacion_consultas', ['id'=> $publicacion->hash]) }}" class="btn btn-primary">Volver a consultas</strong></a>
                                </div>
