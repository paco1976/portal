					...
					<div class="row">
						...
						<div class="col-md-4">
							<div class="contact-details">
								<h4>Contacto</h4>
								<ul class="contact">
									<li><p><i class="fa fa-map-marker"></i> <strong>Dirección:</strong> Morón 2538. Flores, CABA</p></li>
									<li><p><i class="fa fa-phone"></i> <strong>Telefono:</strong> 4611-5374 / 4637-8465</p></li>
									<li><p><i class="fa fa-envelope"></i> <strong>Email:</strong> <a href="mailto:info@cefeperes.com.ar">info@serviciosprofesionales.com.ar</a></p></li>
								</ul>
							</div>
						</div>
						<div class="col-md-2">
