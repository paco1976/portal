			...
			<div role="main" class="main">
				...
				<section class="page-top">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12">
								<h1>Publicación de {{ $user->name }} {{ $user->last_name }}</h1>
							</div>
					...
					<div class="row">
						<div class="col-md-9">
							...
							<div class="panel-body">
									...
									<form class="form-horizontal form-bordered" action="{{ route('prof_publicacion_update', ['hash_user' => $user->hash]) }}" method="POST" enctype="multipart/form-data" >
                        			{{ method_field('PUT') }}
									@csrf
