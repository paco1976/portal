			...
			<div role="main" class="main">
				...
				<section class="page-top">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12">
								<h1><a href="{{ route('admin_publicaciones_user', ['user_hash' => $publicacion->user->hash]) }}" > Volver a PUBLICACIONES</a></h1>
							</div>
                                ...
                                @foreach($interactionhead_all as $interactionhead)
									<tr class="gradeX">
										...
										<td class="actions" style="text-align:center">
											...
											<a href="{{ route('admin_mensajes', ['head_hash'=> $interactionhead->hash]) }}" class="btn btn-danger"><i class="fa fa-comments"></i></a>
											@else
											<a href="{{ route('admin_mensajes', ['head_hash'=> $interactionhead->hash]) }}" class="btn btn-success"><i class="fa fa-comments"></i></a>
											@endif
										</td>
									</tr>
                                @endforeach
