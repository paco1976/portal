			...
			<div role="main" class="main">
				...
				<section class="page-top">
					<div class="container">
						...
						<div class="row">
							<div class="col-md-12">
								<h1>Profesional {{$user->name }} {{ $user->last_name }}</h1>
							</div>
						...
						<div class="col-md-9">
							...
							<div class="tabs">
                                ...
                                <div class="col-md-4">
                                        ...
                                        <form action="{{ route('prof_avatarupload', ['user_hash' => $user->hash])  }}" method="POST" enctype="multipart/form-data" >
                                            {{ method_field('PUT') }}
                                            @csrf
                                        ...
                                        @else
                                        <a href="{{ route('prof_avatardelete', ['user_hash' => $user->hash])  }}" class="btn btn-default fileupload-exists" data-dismiss="fileupload">Quitar imagen</a>
                                        @endif
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <a href="{{ route('prof_perfil_edit', ['user_hash' => $user->hash])  }}" class="btn btn-primary" data-dismiss="fileupload">Editar</a>
                                    @endif
